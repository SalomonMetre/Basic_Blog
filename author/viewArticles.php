...
$st="SELECT *FROM article WHERE author='$guideAuthor'";
$Res=$dbConn->query($st);
...
.myFooter{
  ...
  <p style=" font-family: courier; line-height: 50px; margin-left: 100px; margin-right:100px; font-size: 1.2em;">Dear <b><?php echo $guideAuthor; ?></b>,here is where you can view the different articles published by you and other authors. These articles touch many aspects of our lives and treat many amazing scientific topics. <br> <br>  Enjoy your reading 😊😊🔆</p> <hr>
   <?php
   ...
   <?php echo $article; ?> <br>
   <a href="editArticle.php?id=<?php echo $id; ?>" style="border-radius:10px; width:400px; padding:5px; background-color:blue; color:white">Edit</a> <a style="border-radius:10px; width:400px; padding:5px; background-color:blue; color:white" href="delArticle.php?id=<?php echo $id; ?>">Delete</a> <hr>
    </p>
   <?php
    }
    ?>
