...
.myFooter{
  ...
  <p style=" font-family: courier; line-height: 50px; margin-left: 100px; margin-right:100px; font-size: 1.2em;">Dear <b><?php echo $guideAdmin; ?></b>,here is where you can view the different articles published the different authors. These articles touch many aspects of our lives and treat many amazing scientific topics. <br> <br>  Enjoy your reading 😊😊🔆</p> <hr>
   <?php
