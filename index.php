...
.myform label{
  ...
  <div class="container">
    <div class="row" id="myrow">
     <div class="col-8">
       <form class="myform" action="saveDetails.php" method="post">
       ...
       <input type="submit" name="" value="SIGN UP" style=" background-color: rgb(0,0,400);"> <br>
      <span style=" font-family: courier; font-weight: bolder; color:white;font-size: 1.1em; ">If you are registered,<a href="signin.php">Log in</a></span>
     </form>
     </div>
    </div>
  </div>
